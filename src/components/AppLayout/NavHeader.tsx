...
const NavHeader = () => {
	return (
		<Header className='h-[183px] p-0 m-0 flex flex-col bg-transparent'>
			<section className='max-h-[82.53px] px-[50px] border-0 border-b-[1.5px] border-solid border-blue_primary flex items-center justify-between text-grey_primary m-0'>
			...
			<section className='max-h-[99.96px] px-[50px] border-0 border-b-[1.5px] border-solid border-blue_primary flex items-center justify-between text-grey_primary m-0'>
