...
const ModalStrategyDeleteFooter = () => {
	const dispatch = useDispatch();
	const { strategyIdTobeDeleted } = useRoomSelector();
	return (
		<>
			...
			>
				...
				<button
					...
					onClick={() => {
						...
						dispatch(roomActions.setRoomSettingsStrategiesDelete(strategyIdTobeDeleted));
					}}
				>
                    Confirm
				</button>
...
export default ModalStrategyDeleteFooter;